\label{4.1 C5E Chapter Performance}
    \subsection{\%}
    \renewcommand{\insertclass}{- Class 5}
    \renewcommand{\insertsubject}{English}


    \begin{frame}{Chapter Wise Performance - Class 5 English}
    \hspace{-0.5cm}
    ...
    {86}%average
    {\highgreen{Understanding Skills}, {Analytical Skills}, {Attention to Details}}%chaptername
    \end{minipage}
    \end{frame}%
