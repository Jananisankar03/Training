\label{4.1 C6E Chapter Performance}
    \subsection{\%}
    \renewcommand{\insertclass}{- Class 6}
    \renewcommand{\insertsubject}{English}


    \begin{frame}{Chapter Wise Performance - Class 6 English}
    \hspace{-0.5cm}
    ...
    {86}%average
    {{Interpretation Skill}, \highgreen{Attention to Details}, \highgreen{Understanding Skills}, \highyellow{Analytical Skills}}%chaptername
    \end{minipage}
    \end{frame}%
